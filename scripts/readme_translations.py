...
TRANSLATIONS = {
    ...
    "de": {
        ...
        HERO2: "523 Lektionen. 20 Phasen. ~342 Stunden. Python, TypeScript, Rust, Julia. Jede Lektion liefert ein wiederverwendbares Artefakt: einen Prompt, eine Skill, einen Agenten, einen MCP-Server. Kostenlos, Open Source, MIT.",
